...
/**
 * Helper methods related to requesting and receiving the latest news articles from The Guardian.
 */
public final class NewsQuery {
    ...
    /**
     * Create a private constructor because no one should ever create a {@link NewsQuery} object.
     * This class is only meant to hold static variables and methods, which can be accessed
     * directly from the class name NewsQuery (and an object instance of NewsQuery is not needed).
     */
    private NewsQuery() {
    }
    ...
    private static List<News> extractResultsFromJson(String newsJSON) {
        //        Display empty view for a few seconds
        try {
            Thread.sleep(2000);
        ...
        try {
            ...
            // Get the JSONObject with name "response" from the base query
            JSONObject response = baseJsonResponse.optJSONObject("response");

            // Extract the JSONArray associated with the key called "results",
            // which represents a list of results (or newsArticles).
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                JSONObject currentArticle = newsArray.optJSONObject(i);
                ...
                // Extract the JSONObject "fields" to get the author
                ...
                // Create a new {@link News} object with the section_name, title, id,
                // and url from the JSON response.
                News article = new News(section, title, author, date, url);

                // Add the new {@link Earthquake} to the list of newsArticles.
            ...
            Log.e("NewsQuery", "Problem parsing the Guardian JSON results", e);
        }
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            // If the request was successful (i.e. response code 200 also HttpURLConnection.HTTP_OK),
